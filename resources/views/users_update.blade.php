                                ...
                                <form action="{{ route('admin.query.users.update') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="role" @error('role') is-invalid @enderror>
                                            <option @if ($user->Role == 'Клиент') checked @endif value="Клиент">Клиент</option>
                                            <option @if ($user->Role == 'Администратор') checked @endif value="Администратор">Администратор</option>
                                            <option @if ($user->Role == 'Менеджер') checked @endif value="Менеджер">Менеджер</option>
                                        </select>
